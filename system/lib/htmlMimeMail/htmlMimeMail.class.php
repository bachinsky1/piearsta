...
/**
* o------------------------------------------------------------------------------o
* | This is HTMLMimeMail. It is dual licensed as GPL and a commercial license.  |
...
class fileAttachment extends attachment
{
    ...
    */
    public function __construct($filename, $simple = true, $contentType = 'application/octet-stream', $encoding = null)
    {
        ...
        if ($simple) {
        	...
        	parent::__construct($filename['content'], basename($filename['filename']), $contentType, $encoding);
        }
