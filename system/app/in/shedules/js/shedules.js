...
function sheduleBook(id) {
    
        if (ruSure(langStrings.getMsg('rusure_book','Are yor sure want to book this time slots ?'))) {
            ajaxRequest(moduleTable.getRequestUrl() + "book/", "id=" + id , updateModule);
        }
}
