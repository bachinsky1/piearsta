 ...
 *
 * This creates new page record for DMSS Auth, creates the necessary mirror and mapping
 *
 * */
...
$dbQuery = "
    INSERT INTO ad_content 
        (parent_id,lang,url,country,mirror_id,`type`,target,template,template_color,page_title,title,full_title,
         ...
         VALUES
	    ($welcomePageId,'lv','lv/dmss-auth/',1,1111,'s','',$templateId,NULL,'DMSS Auth','DMSS Auth','','','','',0,'always',0,'','DMSS Auth','AndreyV',1633013713,0,0,0,'admin',1631715473,30,1,1,0,0,'',1);
";
...
// get new page id
$newId = null;
$dbQuery = "SELECT * FROM ad_content WHERE url = 'lv/dmss-auth/'";
$query = new query($mdb, $dbQuery);
...
$dbQuery = "INSERT INTO ad_sitedata 
            ...
            VALUES
           ('mirros_dmss_auth_page','Mirrors','DMSS Auth page','','selcat',0,0,0,NULL,NULL,'');";
doQuery($mdb, $dbQuery);

// get new mirror id
$newMirror = null;
$dbQuery = "SELECT * FROM ad_sitedata WHERE name = 'mirros_dmss_auth_page'";
$query = new query($mdb, $dbQuery);
